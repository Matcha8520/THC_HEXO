...
.cover-wrapper .cover-body
  ...
  .title
    ...
    line-height: 1.2;
    color: rgba(220, 235, 255, 0.95); /* 温柔的淡蓝白 */
    text-shadow:
  ...
  @media (max-width: 840px) {
    .title {
      font-size: $fontsize-large * 2.5; /* 用 CSS 变量或回退值 */
      line-height: 1.15;
      letter-spacing: 1px;
      text-shadow: 1px 1px 6px rgba(0,0,0,0.35), 0 0 1px rgba(255,255,255,0.18);
    }
  }
  ...
  @media (max-width: 420px) {
    .title {
      font-size: $fontsize-large * 1.7;
      line-height: 1.1;
      letter-spacing: 0.6px;
      text-shadow: 1px 1px 5px rgba(0,0,0,0.32), 0 0 1px rgba(255,255,255,0.15);
    }
  }
